...
<head>
    ...
    <%--<script type="text/javascript" src="<%=path%>/static/js/config.js"></script>--%>
...
<div id="login-div" class="container main">
    <div class="col-md-6 col-md-offset-3">
        <h2 class="text-center" style="color: #1a70fe;">用户登录</h2>

        <form id="login-form" action="<%=path%>/user/userLogin.do" method="post">
            ...
            <a href="<%=path%>/first/searchPass.jsp" style="position: absolute;left: 180px;margin-top:-40px;">忘记用户名/密码</a>&nbsp;
            <a href="<%=path%>/first/register.jsp" style="position:absolute;left: 400px;margin-top: -40px;">还没有帐号?点击注册</a>
