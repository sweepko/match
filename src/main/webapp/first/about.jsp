...
<head>
    <title>关于我们</title>
    <!-- CSS 样式 -->
    <link rel="stylesheet" href="<%=path%>/static/shopping/style.css" media="all">
...
<h1 align="center" style="margin-top: 50px;font-family: '隶书';">赛事管理平台介绍</h1>
<canvas style="margin-left: 200px;margin-top: -100px;margin-bottom: -20px;" id="output" width="900" height="600"
